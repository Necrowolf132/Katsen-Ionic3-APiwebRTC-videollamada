...
export class HomePage {
  ...
  InitializeApiRTC() {
    ...
    apiRTC.init({
      apiKey: "6d41b99b3617b53001a470b3a8bb79f9",
      // apiCCId : "2",
      onReady: (e) => {
  ...
  AddEventListeners() {
    ...
    apiRTC.addEventListener("userMediaError", (e) => {
      ...
      this.status = this.status + "<br/> EL siguiente error ah ocurrido <br/> " + e;
    });
    ...
    apiRTC.addEventListener("hangup", (e) => {
      ...
      this.status = this.status + "<br/> La llamada termino por los Siguientes motivos: <br/> " + e.detail.reason;
